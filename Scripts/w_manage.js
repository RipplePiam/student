...
close cnamecursor;									// 关闭游标
st_4.text=tname_info
pb_2.enabled=false									// 使 "输入成绩"按钮失效
...
if ddlb_cname.text = "" then 
	...
	pb_2.enabled=true
	st_2.text = "任课教师: "						// 将静态文本框 st_2 显示内容修改为"任课教师"
	st_6.text = tname_info							// 使静态文本框 st_6 显示内容为"所选择课程的任课教师"
end if 
